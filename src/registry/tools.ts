...
const definitions = [
  {
    id: 'xml', name: 'XML Formatter / Validator', description: 'Format, minify and validate XML safely on your device.', category: 'Developer', icon: CodeXml,
    keywords: ['xml', 'namespace', 'cdata', 'validate', 'pretty', 'markup'], color: 'violet', component: lazy(()=>import('../tools/xml/XmlTool')),
  },
  {
    id: 'code-formatter', name: 'Code Formatter', description: 'Format HTML, CSS and JavaScript with local Prettier.', category: 'Developer', icon: CodeXml,
    keywords: ['html', 'css', 'javascript', 'prettier', 'beautify', 'indent'], color: 'blue', component: lazy(()=>import('../tools/code-formatter/CodeFormatter')),
  },
  {
    id: 'zip', name: 'ZIP Utilities', description: 'Create ZIP archives and safely extract files locally.', category: 'Utilities', icon: Archive,
    keywords: ['archive', 'compress', 'extract', 'unzip', 'files'], color: 'amber', component: lazy(()=>import('../tools/zip/ZipTool')),
    workspaceCompatible: true, acceptsFileTypes: ['application/zip', 'application/x-zip-compressed'], producesFileTypes: ['application/zip','application/octet-stream','image/png','image/jpeg','image/webp','application/pdf','text/plain','application/json'],
  },
  {
    id: 'json',
    name: 'JSON Formatter',
