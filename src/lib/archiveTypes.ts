...
export const ZIP_LIMITS = { entries: 1000, files: 500, bytes: 150 * 1024 ** 2, archiveBytes: 100 * 1024 ** 2, ratio: 200 }
export interface ArchiveEntry { id: number; path: string; size: number; compressedSize: number; directory: boolean }
export interface BackupInput extends FileInput { pinned: boolean; createdAt: number }
